...
## Project Structure
```
├── artifacts/                      # Output artifacts generated by notebooks
│   ├── app/                        # Dockerfile, frontend & backend code, generated images
│   ├── assets/                     # Generated static image resources
│   ├── design/                     # PlantUML source files and rendered UML PNG images
│   └── spec/                       # Auto-generated software specification documents
├── tests/                          # Pytest test cases
├── .env.example                    # API key template for DeepSeek and Dashscope
├── course_feedback_generator.ipynb # Main project notebook
